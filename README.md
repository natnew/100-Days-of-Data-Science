...
- [Anthropic Prompt Engineering](https://docs.anthropic.com/claude/docs/prompt-engineering) — Working with Claude
- [NIST AI Risk Management Framework](https://www.nist.gov/itl/ai-risk-management-framework) — Trustworthy AI
- [Fairness and Machine Learning](http://fairmlbook.org/) — Foundational concepts
- [MLOps Community](https://mlops.community/) — Production patterns
...
2. Follow Python best practices (Black, type hints, docstrings)
...
MIT License. See [`LICENSE`](LICENSE). Use freely for education—just attribute and share improvements back.
...
3. 💻 Begin with Day 1: Intelligent Dataset Profiler
4. 📢 Share progress: #100DaysOfAIDataScience
...
[START YOUR JOURNEY](./projects/day-001/) | [DISCUSSIONS](https://github.com/natnew/100-Days-of-AI-Enhanced-Data-Science/discussions) | [SHOWCASE](./showcase/)